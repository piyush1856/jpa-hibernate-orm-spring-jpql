...
public class StudentController {
	...
	public Student getStudentHandler(@PathVariable("roll") Integer roll) throws InvalidRollException {
...
//		Optional<Student> opt = students.stream().filter(s -> s.getRoll() == roll).findFirst();
//		
//		if(opt.isPresent()) {
//			Student s = opt.get();
//			
//			return s;
//		}else {
//			throw new InvalidRollException("Student not found with roll number : " + roll);
//		}
		...
		return students.stream()
				...
				.findFirst()
				.orElseThrow(() -> new InvalidRollException("Student not found with roll number : " + roll));

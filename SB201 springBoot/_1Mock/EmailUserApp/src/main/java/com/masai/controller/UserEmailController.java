...
public class UserEmailController {
	...
	public ResponseEntity<Email> retriveEmailFromUserHandler(@PathVariable("id") Integer userId, @PathVariable("mail_id") Integer mailId)throws UserException {
		return new ResponseEntity<Email>(ueService.retriveEmailFromUser(userId,mailId),HttpStatus.ACCEPTED);
	}

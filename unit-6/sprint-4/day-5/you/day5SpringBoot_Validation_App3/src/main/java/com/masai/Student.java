...
public class Student {
	...
	//@Min(value = 10,message = "Roll should be greater than equal to10")
	@Min(value = 10, message = "{roll.invalid}")
	private Integer roll;
	
	//@Size(min = 3, max = 15, message = "length should be min 3 or max 15")
	...
	//not null, not blank, not empty  --> check it out
